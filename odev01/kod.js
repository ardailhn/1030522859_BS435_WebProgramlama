...
showCard = (imgId) => {
    if(kedi == imgId){
        document.getElementById("img"+imgId).src = "kedi.jpg";
        for (let i = 0; i < 3; i++) {
            if(i!=kedi){
                document.getElementById("img"+i).src = "kopek.jpg";
            }
        }
        oyunuBitir("w");
    }else{
        count++;
        document.getElementById("img"+imgId).src = "kopek.jpg";
        if(count == 2){
            document.getElementById("img"+kedi).src = "kedi.jpg";
            oyunuBitir("l");
        }
    }
}
